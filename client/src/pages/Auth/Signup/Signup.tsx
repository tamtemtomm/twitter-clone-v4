...
const Signup = () => {
  ...
  const { mutate, isError, isPending, error } = useMutation({
    ...
    // Throw toast succes when account created
    onSuccess: () => {
      toast.success("Account created succesfully");
    },
  });

  // Handle form submit to mutate data and trigger mutationFn
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    mutate(formData);
  };

  // Handle formdata state
